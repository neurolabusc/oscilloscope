...
TMainPrefs = record
   ...
   customMinMax, AutoSave, Precision16bit, Recording,UnsavedData, DigitalChannel, detectAnalogTriggers : boolean;
   ser:TBlockSerial;
   ...
   TimelineMS,sampleRateHz,sampleRateHzObs,triggerPosition, samplesPerGraph : integer;
   autoSaveDir: string;
