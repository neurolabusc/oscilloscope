...
void setColor (int lineIndex)
{
    ...
    switch(lineIndex) {
        ...
        case 9: [[NSColor yellowColor] set]; break;
        case 10: [[NSColor lightGrayColor] set]; break;
        case 11: [[NSColor darkGrayColor] set]; break;
...
- (void) drawRect:(NSRect) rect {
    ...
    if ((gGraph.lines < 1) || (gGraph.timepoints < 2) || (gGraph.enabled == FALSE)) {
        [@"Please connect to a device to acquire data" drawAtPoint:NSMakePoint(1, 1 ) withAttributes:textDict];
...
//    }
    ...
    a.axisMin = 0;
    a.axisMax = 1;
    a.axisRange = a.axisMax - a.axisMin;
    a.tickSpacing = 0.25;
    //draw lines...
...
- (void) awakeFromNib
{
    gGraph.blackBackground = FALSE;
    gGraph.enabled = TRUE;
    gGraph.timepoints = 20;
